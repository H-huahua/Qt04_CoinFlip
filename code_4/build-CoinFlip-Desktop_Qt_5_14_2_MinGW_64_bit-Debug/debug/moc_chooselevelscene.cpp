...
QT_MOC_LITERAL(1, 17, 14), // "chooseScenBack"
QT_MOC_LITERAL(2, 32, 0) // ""

    },
    "ChooseLevelScene\0chooseScenBack\0"
};
...
void ChooseLevelScene::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->chooseScenBack(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ChooseLevelScene::chooseScenBack)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ChooseLevelScene::chooseScenBack()
{
